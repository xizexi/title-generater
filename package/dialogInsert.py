# -*- coding: utf-8 -*-
"""
Created on Fri May 12 17:04:23 2017
...
class Example(QDialog):
    ...
    def save(self):
        ...
        package.sqlTools.insertNameClickedList(self.nameClicked,self.urlEdit.text(), self.titleEdit.text(), self.descEdit.toPlainText())
